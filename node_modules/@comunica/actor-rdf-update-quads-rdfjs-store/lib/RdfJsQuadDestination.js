...
class RdfJsQuadDestination {
    ...
    delete(quads) {
        return (0, event_emitter_promisify_1.promisifyEventEmitter)(this.store.remove(quads));
    }
    insert(quads) {
        return (0, event_emitter_promisify_1.promisifyEventEmitter)(this.store.import(quads));
    }
    async deleteGraphs(graphs, _requireExistence, _dropGraphs) {
        switch (graphs) {
            case 'ALL':
                ...
                await (0, event_emitter_promisify_1.promisifyEventEmitter)(this.store.deleteGraph(DF.defaultGraph()));
