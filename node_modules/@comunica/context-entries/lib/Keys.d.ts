...
import type { IPhysicalQueryPlanLogger, QueryExplainMode, IProxyHandler, ICliArgsHandler, IDataDestination, MetadataBindings, FunctionArgumentsCache, IAggregatedStore, QuerySourceUnidentified, IQuerySourceWrapper, QuerySourceReference } from '@comunica/types';
