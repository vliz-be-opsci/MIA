 ...
 */
export declare abstract class ActorQueryProcess extends Actor<IActionQueryProcess, IActorTest, IActorQueryProcessOutput> {
    /**
     * @param args - @defaultNested {<default_bus> a <cc:components/Bus.jsonld#Bus>} bus
     */
    constructor(args: IActorQueryProcessArgs);
}
...
export type IActorQueryProcessArgs = IActorArgs<IActionQueryProcess, IActorTest, IActorQueryProcessOutput>;
