 ...
 */
export declare abstract class ActorContextPreprocess extends Actor<IActionContextPreprocess, IActorTest, IActorContextPreprocessOutput> {
    /**
...
export type IActorContextPreprocessArgs = IActorArgs<IActionContextPreprocess, IActorTest, IActorContextPreprocessOutput>;
