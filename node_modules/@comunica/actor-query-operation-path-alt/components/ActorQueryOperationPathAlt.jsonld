  ...
  "components": [
    {
      ...
      "parameters": [
        {
          "@id": "caqopa:components/ActorQueryOperationPathAlt.jsonld#ActorQueryOperationPathAlt_args_mediatorRdfMetadataAccumulate",
      ...
      "memberFields": [
        {
          "@id": "caqopa:components/ActorQueryOperationPathAlt.jsonld#ActorQueryOperationPathAlt__member_mediatorRdfMetadataAccumulate",
    ...
    {
      "@id": "caqopa:components/ActorQueryOperationPathAlt.jsonld#IActorQueryOperationPathAltArgs",
      "@type": "AbstractClass",
      "requireElement": "IActorQueryOperationPathAltArgs",
      "extends": [
      ...
      "memberFields": [
        {
          "@id": "caqopa:components/ActorQueryOperationPathAlt.jsonld#IActorQueryOperationPathAltArgs__member_mediatorRdfMetadataAccumulate",
          "memberFieldName": "mediatorRdfMetadataAccumulate"
        }
      ],
      "constructorArguments": []
