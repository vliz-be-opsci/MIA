{
  ...
  "@id": "npmd:@comunica/actor-rdf-parse-shaclc",
  "components": [
    {
      "@id": "carps:components/ActorRdfParseShaclc.jsonld#ActorRdfParseShaclc",
      "@type": "Class",
      "requireElement": "ActorRdfParseShaclc",
      "extends": [
        "cbrp:components/ActorRdfParseFixedMediaTypes.jsonld#ActorRdfParseFixedMediaTypes"
      ],
      "comment": "A comunica SHACL Compact Syntax RDF Parse Actor.",
      "parameters": [
        {
          "@id": "carps:components/ActorRdfParseShaclc.jsonld#ActorRdfParseShaclc_args_mediaTypePriorities",
          "range": "rdf:JSON",
          "default": {
            "@type": "@json",
            "@value": {
        ...
        {
          "@id": "carps:components/ActorRdfParseShaclc.jsonld#ActorRdfParseShaclc_args_mediaTypeFormats",
          "range": "rdf:JSON",
          "default": {
            "@type": "@json",
            "@value": {
        ...
        {
          "@id": "carps:components/ActorRdfParseShaclc.jsonld#ActorRdfParseShaclc_args_priorityScale",
          "range": {
        ...
        {
          "@id": "carps:components/ActorRdfParseShaclc.jsonld#ActorRdfParseShaclc_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "carps:components/ActorRdfParseShaclc.jsonld#ActorRdfParseShaclc_args_bus",
          "range": {
        ...
        {
          "@id": "carps:components/ActorRdfParseShaclc.jsonld#ActorRdfParseShaclc_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "carps:components/ActorRdfParseShaclc.jsonld#ActorRdfParseShaclc__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "carps:components/ActorRdfParseShaclc.jsonld#ActorRdfParseShaclc__member_runHandle",
          "memberFieldName": "runHandle"
        }
      ],
      "constructorArguments": [
        {
          "@id": "carps:components/ActorRdfParseShaclc.jsonld#ActorRdfParseShaclc_args__constructorArgument",
          "fields": [
            {
