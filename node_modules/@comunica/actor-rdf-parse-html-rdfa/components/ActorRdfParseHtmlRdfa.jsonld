{
  "@context": [
    "https://linkedsoftwaredependencies.org/bundles/npm/@comunica/actor-rdf-parse-html-rdfa/^3.0.0/components/context.jsonld",
  ...
  "@id": "npmd:@comunica/actor-rdf-parse-html-rdfa",
  "components": [
    {
      "@id": "carphr:components/ActorRdfParseHtmlRdfa.jsonld#ActorRdfParseHtmlRdfa",
      "@type": "Class",
      "requireElement": "ActorRdfParseHtmlRdfa",
      "extends": [
        "cbrph:components/ActorRdfParseHtml.jsonld#ActorRdfParseHtml"
      ],
      "comment": "A comunica RDFa RDF Parse Html Actor.",
      "parameters": [
        {
          "@id": "carphr:components/ActorRdfParseHtmlRdfa.jsonld#ActorRdfParseHtmlRdfa_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
      ...
      "memberFields": [
        {
          "@id": "carphr:components/ActorRdfParseHtmlRdfa.jsonld#ActorRdfParseHtmlRdfa__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "carphr:components/ActorRdfParseHtmlRdfa.jsonld#ActorRdfParseHtmlRdfa__member_test",
          "memberFieldName": "test"
        },
        {
          "@id": "carphr:components/ActorRdfParseHtmlRdfa.jsonld#ActorRdfParseHtmlRdfa__member_run",
          "memberFieldName": "run"
        }
      ],
      "constructorArguments": [
        {
          "@id": "carphr:components/ActorRdfParseHtmlRdfa.jsonld#ActorRdfParseHtmlRdfa_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "name",
              "value": {
