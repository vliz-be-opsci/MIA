...
export declare abstract class ActorRdfJoin extends Actor<IActionRdfJoin, IMediatorTypeJoinCoefficients, IQueryOperationResultBindings> {
     ...
     */
    static sortJoinEntries(mediatorJoinEntriesSort: MediatorRdfJoinEntriesSort, entries: IJoinEntryWithMetadata[], context: IActionContext): Promise<IJoinEntryWithMetadata[]>;
    /**
