  ...
  "components": [
    {
      ...
      "memberFields": [
        {
          "@id": "caqoj:components/ActorQueryOperationJoin.jsonld#ActorQueryOperationJoin__member_mediatorJoin",
      ...
      "constructorArguments": [
        {
          "@id": "caqoj:components/ActorQueryOperationJoin.jsonld#ActorQueryOperationJoin_args__constructorArgument",
          "fields": [
            {
              "keyRaw": "mediatorJoin",
              "value": {
    ...
    },
    {
      ...
      "@type": "AbstractClass",
      "requireElement": "IActorQueryOperationJoinArgs",
      "extends": [
