{
  ...
  "components": [
    {
      "@id": "carpn:components/ActorRdfParseN3.jsonld#ActorRdfParseN3",
      "@type": "Class",
      "requireElement": "ActorRdfParseN3",
      "extends": [
        "cbrp:components/ActorRdfParseFixedMediaTypes.jsonld#ActorRdfParseFixedMediaTypes"
      ],
      "comment": "An N3 RDF Parse actor that listens on the 'rdf-parse' bus.  It is able to parse N3-based RDF serializations and announce the presence of them by media type.",
      "parameters": [
        {
          "@id": "carpn:components/ActorRdfParseN3.jsonld#ActorRdfParseN3_args_mediaTypePriorities",
          "range": "rdf:JSON",
          "default": {
            "@type": "@json",
            "@value": {
        ...
        {
          "@id": "carpn:components/ActorRdfParseN3.jsonld#ActorRdfParseN3_args_mediaTypeFormats",
          "range": "rdf:JSON",
          "default": {
            "@type": "@json",
            "@value": {
        ...
        {
          "@id": "carpn:components/ActorRdfParseN3.jsonld#ActorRdfParseN3_args_priorityScale",
          "range": {
        ...
        {
          "@id": "carpn:components/ActorRdfParseN3.jsonld#ActorRdfParseN3_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "carpn:components/ActorRdfParseN3.jsonld#ActorRdfParseN3_args_bus",
          "range": {
        ...
        {
          "@id": "carpn:components/ActorRdfParseN3.jsonld#ActorRdfParseN3_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberFields": [
        {
          "@id": "carpn:components/ActorRdfParseN3.jsonld#ActorRdfParseN3__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "carpn:components/ActorRdfParseN3.jsonld#ActorRdfParseN3__member_runHandle",
          "memberFieldName": "runHandle"
        }
      ],
      "constructorArguments": [
        {
          "@id": "carpn:components/ActorRdfParseN3.jsonld#ActorRdfParseN3_args__constructorArgument",
          "fields": [
            {
