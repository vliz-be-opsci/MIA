 ...
 */
export declare abstract class ActorQuerySourceIdentifyHypermedia extends Actor<IActionQuerySourceIdentifyHypermedia, IActorQuerySourceIdentifyHypermediaTest, IActorQuerySourceIdentifyHypermediaOutput> {
    protected readonly sourceType: string;
    /**
     * @param args - @defaultNested {<default_bus> a <cc:components/Bus.jsonld#Bus>} bus
     * @param sourceType The source type.
     */
    constructor(args: IActorQuerySourceIdentifyHypermediaArgs, sourceType: string);
    test(action: IActionQuerySourceIdentifyHypermedia): Promise<IActorQuerySourceIdentifyHypermediaTest>;
    abstract testMetadata(action: IActionQuerySourceIdentifyHypermedia): Promise<IActorQuerySourceIdentifyHypermediaTest>;
}
...
export type IActorQuerySourceIdentifyHypermediaArgs = IActorArgs<IActionQuerySourceIdentifyHypermedia, IActorQuerySourceIdentifyHypermediaTest, IActorQuerySourceIdentifyHypermediaOutput>;
