...
class RdfObjectLoader {
    constructor(args) {
        ...
        this.uniqueLiterals = Boolean(args === null || args === void 0 ? void 0 : args.uniqueLiterals);
    ...
    getOrMakeResource(term) {
        if (this.uniqueLiterals && term.termType === 'Literal') {
            return new Resource_1.Resource({ term, context: this.contextResolved });
        }
    ...
    createCompactedResource(hash) {
        ...
        if (typeof hash !== 'object') {
            ...
            return this.getOrMakeResource((0, rdf_string_1.stringToTerm)(hash, this.dataFactory));
        }
            ...
            stream.on('end', () => {
                if (this.normalizeLists) {
                    for (const listRoot of listMaterializer.getRoots()) {
                        ...
                        this.resources[(0, rdf_string_1.termToString)(listRoot)].list = listTerms.map(term => this.getOrMakeResource(term));
                    }
                }
                resolve();
            });
